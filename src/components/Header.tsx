...
import Sidebar from "@/components/Sidebar"; // ← mount once here so it can overlay on mobile
...
export default function Header() {
  ...
  // close profile menu on outside click (minor polish)
  ...
  return (
    <>
        ...
        <div className="mx-auto max-w-7xl px-4">
          <div className="flex items-center justify-between gap-4 py-2">
            ...
            <div className="flex min-w-0 items-center gap-3">
              ...
              {/* Appointment pill (hide on small screens) */}
                ...
                <div className="relative" ref={profileRef}>
                  ...
                  {menuOpen && (
                    ...
                    >
                      ...
                      >
                        <i
                          className={`fas fa-right-from-bracket ${linkIcon}`}
                        />
                        Logout
                      </button>
                    </div>
      ...
      {/* Sidebar mounts once so:
          - On mobile: it becomes a drawer controlled by `sidebarOpen`
          - On desktop (lg+): it renders the fixed rail automatically */}
      <div id="app-sidebar">
